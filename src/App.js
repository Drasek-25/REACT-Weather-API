      ...
      {todaysWeather.cod && fiveDayWeather.cod ? (
        <>
          <div className="today col">
            ...
            <span className="info">
              Feels Like: {Math.round(todaysWeather.main.feels_like) + "\xB0"}
            </span>
            <span className="info">
              Min Temp: {Math.round(todaysWeather.main.temp_min) + "\xB0"}
            </span>
            <span className="info">
              Max Temp: {Math.round(todaysWeather.main.temp_max) + "\xB0"}
            </span>
            <span className="info">
              Humidity: {todaysWeather.main.humidity + "%"}
            </span>
            <span className="info">Wind Speed: {todaysWeather.wind.speed}</span>
          </div>
